...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`documento_identificacion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`persona` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`pasajero` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`tipo_avion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`estado_avion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`avion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`clase` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`asiento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`dias_plan_vuelo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`plan_vuelo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`vuelo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`boleto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`aeropuerto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`salida_plan_vuelo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`llegada_plan_vuelo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`estado_vuelo` ;
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`estado_vuelo` (
  ...
  INDEX `fk_estado_vuelo_vuelo1_idx` (`vuelo_id_vuelo` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`distribucion_asiento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`beneficios_extra` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`nacionalidad` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`maleta_documentada` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`mascota` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`lista_vacunas` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`asignacion_mascota` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`encuesta` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`tipo_empleado` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`personal_aeropuerto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`solicitudes_vacaciones` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`asignacion_tripulacion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`comisiones` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`precio` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`nomina_sueldos_empleados` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`tipo_cuenta` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`usuario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`cortesia` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`historial_cuentas_usuario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`estado_compra` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`compra` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`aseguranza` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`detalle_compra` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`maleta_mano` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`metodo_pago` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`compra_vuelo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`pago` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`detalle_pago` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`servicio` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`genero` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`pelicula` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`pelicula_tiene_genero` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`actor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`pelicula_tiene_actor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`servicio_digital` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`menu_comida` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`menu_gratis` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`vuelo_tiene_servicio` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`detalle_compra_vuelo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`asignacion_nino_pasajero` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HorizonteGT`.`asignacion_nino_tripulante` ;
