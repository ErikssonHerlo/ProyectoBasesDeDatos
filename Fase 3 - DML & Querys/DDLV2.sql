...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`dias_plan_vuelo` (
  `id_dias_plan_vuelo` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`plan_vuelo` (
  `id_plan_vuelo` BIGINT NOT NULL AUTO_INCREMENT,
  `dias_plan_vuelo_id_dias_plan_vuelo` INT NOT NULL,
  `distancia` DOUBLE NULL,
  `tipo_avion_tipo_avion` VARCHAR(50) NOT NULL,
  `es_temporal` TINYINT NULL,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`distribucion_asiento` (
  `id_distribucion_asiento` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`beneficios_extra` (
  `id_beneficios_extra` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`mascota` (
  ...
  `certificado_veterinario` TINYINT NULL,
  `descripcion` TEXT NULL,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`solicitudes_vacaciones` (
  `no_solicitud` INT NOT NULL AUTO_INCREMENT,
  `estado` VARCHAR(45) NULL,
  `fecha` DATE NULL,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`nomina_sueldos_empleados` (
  `id_nomina_sueldos_empleados` INT NOT NULL AUTO_INCREMENT,
  `sueldo_base` DECIMAL(10,2) NULL,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`cortesia` (
  `id_cortesia` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`historial_cuentas_usuario` (
  `id_historial_cuentas_usuario` BIGINT NOT NULL AUTO_INCREMENT,
  `usuario_pasaporte` VARCHAR(50) NOT NULL,
  `username` VARCHAR(45) NULL,
  `tipo_cuenta_nombre_cuenta` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`aseguranza` (
  `id_aseguranza` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`maleta_mano` (
  `id_maleta_mano` BIGINT NOT NULL AUTO_INCREMENT,
  `peso` DOUBLE NULL,
  `descripcion` TEXT NULL,
  `boleto_idboleto` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`menu_gratis` (
  `id_menu_gratis` BIGINT NOT NULL AUTO_INCREMENT,
  `bebida` TEXT NULL,
  `comida` TEXT NULL,
  `clase_nombre_clase` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`detalle_compra_vuelo` (
  `id_detalle_compra_vuelo` BIGINT NOT NULL AUTO_INCREMENT,
  `cantidad` INT NULL,
  `precio` DECIMAL(10,2) NULL,
  `sub_total` DECIMAL(10,2) NULL,
