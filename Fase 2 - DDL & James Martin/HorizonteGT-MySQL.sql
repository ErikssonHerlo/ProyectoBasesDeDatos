...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`asignacion_mascota` (
  ...
  INDEX `fk_asignacion_mascota_pasajero1_idx` (`pasajero_pasaporte` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HorizonteGT`.`asignacion_nino_pasajero` (
  ...
  `pasajero_pasaporte` VARCHAR(50) NOT NULL,
  INDEX `fk_asignacion_nino_pasajero1_idx` (`nino_pasaporte` ASC) VISIBLE,
  PRIMARY KEY (`nino_pasaporte`, `pasajero_pasaporte`),
  INDEX `fk_asignacion_nino_pasajero_pasajero1_idx` (`pasajero_pasaporte` ASC) VISIBLE,
